...
it(
    'Array Client Works as expected',
    count($userArrayRepository->getUsers()) === 3
);

it(
    'JSON Client Works as expected',
    count($userJSONRepository->getUsers()) === 3
);

it(
    'Array Client : retrieve user by email',
    $userArrayRepository
        ->getUser('laurene.castor@exemple.com')
...
it(
    ...
    $userJSONRepository
        ->getUser('mathieu.nebra@exemple.com')
